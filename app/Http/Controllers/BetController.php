...
//                ->orderBy('total_amount','DESC')
    ...
    public function updateBetNumber(Request $request, BetNumber $betNumber)
    {
        ...
        if ($hasHash) {
            ...
            $digitFormat = $betNumber->bet->digit_format ?? null;
        ...
        $betNumber->bet()->update(['number_format' => $request->number]);
