...
return new class extends Migration
{
    ...
    {
        // Rename VND tables
        Schema::rename('bet_kh', 'bet_kh_vnd');
        Schema::rename('bet_receipt_kh', 'bet_receipt_kh_vnd');
        Schema::rename('bet_number_kh', 'bet_number_kh_vnd');
        Schema::rename('bet_winning_kh', 'bet_winning_kh_vnd');
        Schema::rename('bet_winning_record_kh', 'bet_winning_record_kh_vnd');

        // Create USD equivalents
        Schema::create('bet_receipt_kh_usd', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bet_kh_usd', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bet_number_kh_usd', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bet_winning_kh_usd', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('bet_receipt_id')->nullable();
            $table->unsignedBigInteger('bet_id')->nullable();
        ...
        Schema::create('bet_winning_record_kh_usd', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('bet_number_id')->nullable();
    ...
    {
        Schema::dropIfExists('bet_winning_record_kh_usd');
        Schema::dropIfExists('bet_winning_kh_usd');
        Schema::dropIfExists('bet_number_kh_usd');
        Schema::dropIfExists('bet_kh_usd');
        Schema::dropIfExists('bet_receipt_kh_usd');

        Schema::rename('bet_winning_record_kh_vnd', 'bet_winning_record_kh');
        Schema::rename('bet_winning_kh_vnd', 'bet_winning_kh');
        Schema::rename('bet_number_kh_vnd', 'bet_number_kh');
        Schema::rename('bet_receipt_kh_vnd', 'bet_receipt_kh');
        Schema::rename('bet_kh_vnd', 'bet_kh');
    }
};
