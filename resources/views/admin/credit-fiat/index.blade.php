    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                Credit Management ({{ $currency }})
            </h3>
        </div>
        <div class="card-body pb-2">

            {{-- Date filter --}}
            <form method="GET" action="{{ route('admin.credit-fiat.index', $currency) }}"
                  class="d-flex align-items-center gap-2 mb-3" style="max-width:340px">
                ...
                <table class="table table-striped table-bordered" id="creditTable" style="font-size:13px">
                    ...
                    <tbody>
                        @foreach ($members as $i => $member)
                            @php
                                $acct       = $member->accountManagement
                                                ->where('currency', $currency)
                                                ->first();
                                $balance    = (float)($acct?->bet_credit ?? 0);
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ $historyRoute($member->id) }}" class="dropdown-item">
                                                    📋 History
                                                </a>
                                            </li>
                                        </ul>
