    ...
    <div class="card">
       ...
       <div class="flex w-full space-x-2">
                ...
                <button 
                    ...
                    onclick="searchReceipt('{{ route('admin.report.daily-usd') }}')">
        ...
        <div class="card-body">
            ...
            <thead class="bg-blue-500 text-white font-bold text-sm">
                <tr class="border border-white">
                    <th class="py-2 px-2 border border-black text-center">{{ __('No') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Date') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Weekday') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Account') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Invoice') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Turnover') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Commission') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Net Amount') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Compensate') }}</th>
                    <th class="py-2 px-2 border border-black text-center">{{ __('Win/Lose') }}</th>
                </tr>
            </thead>
                ...
                @if(isset($data) && count($data))
                    ...
                    @foreach($data as $key => $row)
                        @php
                            ...
                            $totalWinLose += $diff;
                        @endphp
                        <tr class="border border-gray-300 hover:bg-gray-100 text-right-left">
