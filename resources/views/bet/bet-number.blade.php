                        ...
                        @if (isset($data) && count($data) > 0)
                            @foreach ($data as $key => $betNumber)
                                <tr class="border border-gray-300 hover:bg-gray-100">
                                    <td
                                        class="py-2 px-1 border border-gray-300 whitespace-nowrap text-[12px] sm:text-bas">
                                        {{ $key + 1 }}</td>
                                    <td
                                        class="py-2 px-1 border border-gray-300 whitespace-nowrap text-[12px] sm:text-bas">
                                    ...
                                    <td
                                        class="text-right py-2 px-1 border border-gray-300 whitespace-nowrap text-[12px] sm:text-bas">
                                        {{ number_format($betNumber->commission ?? 0, 2) }}</td>
                                    <td
                                        class="text-right py-2 px-1 border border-gray-300 whitespace-nowrap text-[12px] sm:text-bas">
                                        {{ number_format($betNumber->net_amount ?? 0, 2) }}</td>
                                    <td
                                        class="text-right py-2 px-1 border border-gray-300 whitespace-nowrap text-[12px] sm:text-bas {{ number_format($betNumber->win_lose ?? 0, 2) < 0 ? 'text-red-500' : '' }}">
