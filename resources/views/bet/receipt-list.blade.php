            ...
            <div class="flex w-full space-x-2">
                <div class="">
                    <div class="relative max-w-sm">
                        ...
                        <input id="datepicker-receipt" value="{{ $date }}" datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text" class="border border-gray-600 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full ps-10" placeholder="Select date" >
                    </div>
                </div>
                <div class="">
