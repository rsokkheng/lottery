<x-app-layout>
    ...
    <div class="bp-wrap">
        ...
        <div class="bp-filter">
            ...
            <button class="bp-search-btn" onclick="searchReceipt('{{ route('bet-usd.bet-list') }}')">
            ...
            <button class="bp-search-btn" style="background:#6b7280;" onclick="clearSearch('{{ route('bet-usd.bet-list') }}')">
                {{ __('message.clear') }}
            </button>
            @endif
        </div>
