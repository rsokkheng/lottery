...
<button class="bp-search-btn" onclick="searchWinning('{{ route('bet-usd.bet-winning') }}')">
            ...
            <button class="bp-search-btn" style="background:#6b7280;" onclick="clearSearch('{{ route('bet-usd.bet-winning') }}')">
                {{ __('message.clear') }}
            </button>
        </div>
