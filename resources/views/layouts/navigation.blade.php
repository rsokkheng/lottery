        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:ms-10 space-x-8">
                    <x-nav-link style="font-size: 16px;font-weight: 800; color:white">{{ __('Bet') }}</x-nav-link>
                    ...
                    <x-nav-link style="font-size: 16px;font-weight: 800; color:white">{{ __('Results') }}</x-nav-link>
                </div>
