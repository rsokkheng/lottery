        ...
        <div class="nav-container">
            ...
            <div class="flex items-center flex-wrap" style="gap: clamp(0.3rem, 1vw, 1.5rem);">
                @if(Auth::user()->roles->pluck('name')->intersect(['admin', 'manager'])->isEmpty())
                    <a href="{{ route('bet-kh.input') }}" 
                       class="{{ Route::is('bet-kh.input') ? 'active-menu' : 'not-active-menu' }} nav-link">
                        {{ __('lang.menu.bet') }}
                    </a>
                @endif
                
                <a href="{{ route('bet-kh.receipt-list') }}" 
                   class="{{ Route::is('bet-kh.receipt-list') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.receipt-list') }}
                </a>
                
                <a href="{{ route('bet-kh.bet-list') }}" 
                   class="{{ Route::is('bet-kh.bet-list') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.bet-list') }}
                </a>
                
                <a href="{{ route('bet-kh.bet-number') }}" 
                   class="{{ Route::is('bet-kh.bet-number') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.bet-number') }}
                </a>
                
                <a href="{{ route('bet-kh.bet-winning') }}" 
                   class="{{ Route::is('bet-kh.bet-winning') ? 'active-menu' : 'not-active-menu' }} nav-link">
                ...
                @if(Auth::user()->roles->pluck('name')->contains('admin'))
                    {{-- Admin --}}
                    <a href="{{ route('bet-kh.reports.daily-manager') }}" 
                       class="{{ Route::is('bet-kh.reports.daily-manager') ? 'active-menu' : 'not-active-menu' }} nav-link">
                        {{ __('lang.menu.daily-report') }}
                    </a>
                    <a href="{{ route('bet-kh.reports.monthly-tracking') }}" 
                       class="{{ Route::is('bet-kh.reports.monthly-tracking') ? 'active-menu' : 'not-active-menu' }} nav-link">
                        {{ __('lang.menu.monthly-report') }}
                    </a>
                @elseif(Auth::user()->roles->pluck('name')->contains('manager'))
                    {{-- Manager --}}
                    <a href="{{ route('bet-kh.reports.daily') }}" 
                       class="{{ Route::is('bet-kh.reports.daily') ? 'active-menu' : 'not-active-menu' }} nav-link">
                        {{ __('lang.menu.daily-report') }}
                    </a>
                    <a href="{{ route('bet-kh.reports.monthly-allmember') }}" 
                       class="{{ Route::is('bet-kh.reports.monthly-allmember') ? 'active-menu' : 'not-active-menu' }} nav-link">
                        {{ __('lang.menu.monthly-report') }}
                    </a>
                ...
                <a href="{{ route('bet-kh.reports.summary') }}" 
                   class="{{ Route::is('bet-kh.reports.summary') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.summary-report') }}
                </a>
                
                <a href="{{ route('bet-kh.result-show') }}" 
                   class="{{ Route::is('bet-kh.result-show') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.result') }}
                </a>
            </div>
        </div>
