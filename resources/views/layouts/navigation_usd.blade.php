        ...
        <div class="nav-container">
            ...
            <div class="flex items-center flex-wrap" style="gap: clamp(0.3rem, 1vw, 1.5rem);">
                @if(Auth::user()->roles->pluck('name')->intersect(['admin', 'manager'])->isEmpty())
                    <a href="{{ route('bet-usd.input') }}" 
                       class="{{ Route::is('bet-usd.input') ? 'active-menu' : 'not-active-menu' }} nav-link">
                        {{ __('lang.menu.bet') }}
                    </a>
                @endif
                
                <a href="{{ route('bet-usd.receipt-list') }}" 
                   class="{{ Route::is('bet-usd.receipt-list') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.receipt-list') }}
                </a>
                
                <a href="{{ route('bet-usd.bet-list') }}" 
                   class="{{ Route::is('bet-usd.bet-list') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.bet-list') }}
                </a>
                
                <a href="{{ route('bet-usd.bet-number') }}" 
                   class="{{ Route::is('bet-usd.bet-number') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.bet-number') }}
                </a>
                
                <a href="{{ route('bet-usd.bet-winning') }}" 
                   class="{{ Route::is('bet-usd.bet-winning') ? 'active-menu' : 'not-active-menu' }} nav-link">
                ...
                <a href="{{ route('bet-usd.reports.summary') }}" 
                   class="{{ Route::is('bet-usd.reports.summary') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.summary-report') }}
                </a>
                
                <a href="{{ route('bet-usd.result-show') }}" 
                   class="{{ Route::is('bet-usd.result-show') ? 'active-menu' : 'not-active-menu' }} nav-link">
                    {{ __('lang.menu.result') }}
                </a>
            </div>
        </div>
