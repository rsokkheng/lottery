            ...
            <table class="border-separate" style="border-spacing: 0 3px;">
                <tbody>
                    <tr>
                        ...
                        <td class="pr-8 whitespace-nowrap">{{ number_format($betAccount, 2) }} VND</td>
                    ...
                    <tr>
                        ...
                        <td class="pr-8 whitespace-nowrap">{{ number_format($totalOutstanding, 2) }} VND</td>
                        <td class="pr-2 font-bold whitespace-nowrap">{{ __('lang.number-wildcard') }}:</td>
                        <td>* = any of 0,1,2,...,9 &nbsp; 11-19(11,12,...,19)</td>
                    </tr>
                    <tr>
                        ...
                        <td>A(A) B(B) C(C) D(D) ABCD(ABCD) Roll(R) Roll 2(R2) Roll Parlay(PL) Cross(x)</td>
                    </tr>
                    <tr>
