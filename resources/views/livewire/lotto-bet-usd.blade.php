            ...
            <table class="border-separate" style="border-spacing: 0 3px;">
                <tbody>
                    <tr>
                        ...
                        <td class="pr-8 whitespace-nowrap">{{ $betAccount ?? 0 }} USD</td>
                    ...
                    <tr>
                        ...
                        <td class="pr-8 whitespace-nowrap">{{ $totalOutstanding }} USD</td>
                    ...
                    <tr>
                        ...
                        <td class="pr-8 whitespace-nowrap">{{ $totalInvoice }} USD</td>
                        ...
                        <td colspan="4" class="pb-1">
                            <div class="flex items-center gap-2 bg-red-50 border border-red-300 text-red-700 rounded px-3 py-1.5 text-xs font-semibold">
                                ...
                                <span class="font-extrabold">
                                    {{ number_format(round($totalDue - $betAccount, 2), 2) }} USD
                                </span>
