    ...
    <div class="grid grid-cols-1 xl:grid-cols-[30%_68%] gap-4 xl:mx-auto bg-white shadow-md py-4 rounded-lg space-x-2">
                <div class="w-[90%] px-2 mb-6 mx-auto w-full max-w-md rounded-lg">
                    ...
                    <button wire:click="handleSave"
                            class="hidden w-full xl:flex justify-center items-center bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                    ...
                    <button wire:click="handleSave"
                            class="xl:hidden w-full flex justify-center items-center bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
