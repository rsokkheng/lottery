<x-app-layout>
    ...
    <div class="bp-wrap">
        <div class="bp-filter">
            ...
            <button class="bp-search-btn" onclick="searchReceipt('{{ route($khRoutePrefix . '.reports.daily-manager') }}')">
                    ...
                    @if (isset($data) && count($data))
                        ...
                        @foreach ($data as $key => $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route($khRoutePrefix . '.reports.daily-member-agent', ['id' => $row->manager_id, 'date' => $date, 'com_id' => $company_id]) }}"
