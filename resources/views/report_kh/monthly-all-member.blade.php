                    ...
                    @if (isset($data) && count($data))
                        ...
                        @foreach ($data as $key => $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route($khRoutePrefix . '.reports.tracking-agent-member', ['id' => $row->user_id, 'startDate' => $startDate, 'endDate' => $endDate, 'com_id' => $company_id]) }}"
                        ...
                        <tr>
                            <td colspan="2" style="background:#f8f9fc;border-top:2px solid #e2e8f0;font-weight:700;text-align:center;">Total</td>
                            ...
                            <td class="bp-num" style="background:#f8f9fc;border-top:2px solid #e2e8f0;font-weight:700;">{{ number_format($totalNetAmt, 3, '.', '') }}</td>
                            <td class="bp-num" style="background:#f8f9fc;border-top:2px solid #e2e8f0;font-weight:700;">{{ number_format($totalCompensate, 3, '.', '') }}</td>
                            <td class="bp-num {{ $tnc }}" style="background:#f8f9fc;border-top:2px solid #e2e8f0;font-weight:700;">{{ number_format($totalWinLose, 3, '.', '') }}</td>
                        </tr>
                    @else
