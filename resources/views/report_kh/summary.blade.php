<x-app-layout>
    ...
    <div class="bp-wrap">
        ...
        <div class="bp-filter">
            ...
            <button class="bp-search-btn" onclick="searchReceipt('{{ route($khRoutePrefix . '.reports.summary') }}')">
            ...
            <button class="bp-search-btn" style="background:#6b7280;" onclick="clearSearch('{{ route($khRoutePrefix . '.reports.summary') }}')">
                {{ __('message.clear') }}
            </button>
        </div>
