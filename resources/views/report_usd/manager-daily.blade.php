<x-app-layout>
    ...
    <div class="bp-wrap">
        <div class="bp-filter">
            ...
            <button class="bp-search-btn" onclick="searchReceipt('{{ route('bet-usd.reports.daily-manager') }}')">
            ...
            <button class="bp-search-btn" style="background:#6b7280;" onclick="clearSearch('{{ route('bet-usd.reports.daily-manager') }}')">
                {{ __('message.clear') }}
            </button>
        </div>
                    ...
                    @if (isset($data) && count($data))
                        ...
                        @foreach ($data as $key => $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('bet-usd.reports.daily-member-agent', ['id' => $row->manager_id, 'date' => $date, 'com_id' => $company_id]) }}"
