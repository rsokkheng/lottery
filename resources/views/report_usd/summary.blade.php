<x-app-layout>
    ...
    <div class="flex-col bg-white rounded-lg px-4 py-4">
            <div class="flex w-full space-x-2">
                ...
                <div class="">
                    <button class="w-full flex justify-center items-center bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" onclick="searchReceipt('{{ route('bet-usd.reports.summary') }}')">
