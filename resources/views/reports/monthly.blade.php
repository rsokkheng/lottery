<x-app-layout>
    ...
    <div class="bp-wrap">
        ...
        @include('partials.lotto-tabs', ['routeKey' => 'monthly-tracking', 'params' => ['startDate' => $startDate, 'endDate' => $endDate, 'com_id' => $company_id]])
                    ...
                    @if (isset($data) && count($data))
                        ...
                        @foreach ($data as $key => $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('reports.monthly-tracking-member', ['id' => $row->manager_id, 'startDate' => $startDate, 'endDate' => $endDate, 'com_id' => $company_id]) }}"
