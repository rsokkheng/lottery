            ...
            <div class="flex w-full space-x-2">
                <div class="">
                    <div class="relative max-w-sm">
                        ...
                        <input id="start-date" value="{{ $date }}" datepicker datepicker-buttons datepicker-autoselect-today datepicker-autohide datepicker-format="yyyy-mm-dd" type="text" class="border border-gray-600 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full ps-10" placeholder="Select date" >
                    </div>
                </div>
                <div class="">
                    <div class="relative max-w-sm">
                        ...
                        <input id="end-date" value="{{ $date }}" datepicker datepicker-buttons datepicker-autoselect-today datepicker-autohide datepicker-format="yyyy-mm-dd" type="text" class="border border-gray-600 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full ps-10" placeholder="Select date" >
                    </div>
                </div>
                <div class="">
                        ...
                        @if(isset($data) && count($data))
                            @foreach($data as $key => $row)
                                <tr class="border border-gray-300 hover:bg-gray-100">
                                    ...
                                    <td class="py-2 px-1 border border-gray-300">{{$row->receipt_date}}</td>
                                    <td class="py-2 px-1 border border-gray-300">{{$row->draw_day}}</td>
                                    <td class="py-2 px-1 border border-gray-300">{{$row->total}}</td>
                                    <td class="text-right py-2 px-1 border border-gray-300">{{$row->Turnover}}</td>
                                    <td class="text-right py-2 px-1 border border-gray-300">{{$row->Commission}}</td>
                                    <td class="text-right py-2 px-1 border border-gray-300">{{$row->NetAmount}}</td>
